        ...
        <div class="random-product-container">
            ...
            <div class="random-product-container__content">
                <div class="item-product">
                    <div class="item-product__title-product"><a href="{{route('products.show',$data['product']->id)}}" class="item-product__title-product__link">{{$data['product']->name}}</a></div>
                    <div class="item-product__thumbnail"><a href="{{route('products.show',$data['product']->id)}}" class="item-product__thumbnail__link"><img src="{{$data['product']->photo}}" alt="Preview-image" class="item-product__thumbnail__link__img"></a></div>
                    <div class="item-product__description">
                        <div class="item-product__description__products-price"><span class="products-price">{{$data['product']->price}} руб.</span></div>
                        <div class="item-product__description__btn-block"><a href="{{route('cart.add',$data['product']->id)}}" class="btn btn-blue">Добавить в корзину</a></div>
                    </div>
                </div>
            </div>
        </div>
